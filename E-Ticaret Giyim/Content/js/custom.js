...
$("#contact").submit(function (e) {
    ...
    if (isValidEmail(email) && (text.length > 100) && (name.length > 1)) {
        $.ajax({
            type: "POST",
            url: '/Home/MesajGonder', 
            data: { ad: name, email: email, konu: subject, mesaj: text },
            dataType: "text",
            success: function () {
...
//$(document).ready(function () {
//    $('a[href="' + this.location.pathname + '"]').addClass('current');
//});

$(document).ready(function () {
    $('a[href="' + this.location.pathname + '"]').attr("id", "current");
});